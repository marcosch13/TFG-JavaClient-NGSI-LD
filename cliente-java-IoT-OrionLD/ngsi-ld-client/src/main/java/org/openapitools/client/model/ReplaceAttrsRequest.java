...
public class ReplaceAttrsRequest extends AbstractOpenApiSchema {
    private static final Logger log = Logger.getLogger(ReplaceAttrsRequest.class.getName());

    public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
        @SuppressWarnings("unchecked")
        @Override
        public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
            if (!ReplaceAttrsRequest.class.isAssignableFrom(type.getRawType())) {
                return null; // this class only serializes 'ReplaceAttrsRequest' and its subtypes
            }
            ...
            return (TypeAdapter<T>) new TypeAdapter<ReplaceAttrsRequest>() {
                @Override
                public void write(JsonWriter out, ReplaceAttrsRequest value) throws IOException {
                    ...
                    throw new IOException("Failed to serialize as the type doesn't match oneOf schemas: GeoProperty, LanguageProperty, Property, Relationship, VocabularyProperty");
                }

                @Override
                public ReplaceAttrsRequest read(JsonReader in) throws IOException {
                    ...
                    if (match == 1) {
                        ReplaceAttrsRequest ret = new ReplaceAttrsRequest();
                        ret.setActualInstance(actualAdapter.fromJsonTree(jsonElement));
                        return ret;
                    }

                    throw new IOException(String.format("Failed deserialization for ReplaceAttrsRequest: %d classes match result, expected 1. Detailed failure message for oneOf schemas: %s. JSON: %s", match, errorMessages, jsonElement.toString()));
                }
            }.nullSafe();
        }
    }
    ...
    public ReplaceAttrsRequest() {
        super("oneOf", Boolean.FALSE);
    }

    public ReplaceAttrsRequest(Object o) {
        super("oneOf", Boolean.FALSE);
        setActualInstance(o);
    }
    ...
    public Map<String, Class<?>> getSchemas() {
        return ReplaceAttrsRequest.schemas;
    }

    /**
     * Set the instance that matches the oneOf child schema, check
     * the instance parameter is valid against the oneOf child schemas:
     * GeoProperty, LanguageProperty, Property, Relationship, VocabularyProperty
     *
    ...
    public void setActualInstance(Object instance) {
        ...
        throw new RuntimeException("Invalid instance type. Must be GeoProperty, LanguageProperty, Property, Relationship, VocabularyProperty");
    }
     ...
     * GeoProperty, LanguageProperty, Property, Relationship, VocabularyProperty
     *
     * @return The actual instance (GeoProperty, LanguageProperty, Property, Relationship, VocabularyProperty)
     */
    @SuppressWarnings("unchecked")
    @Override
     ...
     * @throws IOException if the JSON Element is invalid with respect to ReplaceAttrsRequest
     */
    public static void validateJsonElement(JsonElement jsonElement) throws IOException {
        ...
        if (validCount != 1) {
            throw new IOException(String.format("The JSON string is invalid for ReplaceAttrsRequest with oneOf schemas: GeoProperty, LanguageProperty, Property, Relationship, VocabularyProperty. %d class(es) match the result, expected 1. Detailed failure message for oneOf schemas: %s. JSON: %s", validCount, errorMessages, jsonElement.toString()));
        }
    }

    /**
     * Create an instance of ReplaceAttrsRequest given an JSON string
     *
     * @param jsonString JSON string
     * @return An instance of ReplaceAttrsRequest
     * @throws IOException if the JSON string is invalid with respect to ReplaceAttrsRequest
     */
    public static ReplaceAttrsRequest fromJson(String jsonString) throws IOException {
        return JSON.getGson().fromJson(jsonString, ReplaceAttrsRequest.class);
    }

    /**
     * Convert an instance of ReplaceAttrsRequest to an JSON string
     *
     * @return JSON string
     */
