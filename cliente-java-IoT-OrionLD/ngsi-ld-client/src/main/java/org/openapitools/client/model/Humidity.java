...
public class Humidity {
  ...
  public Humidity type(@javax.annotation.Nullable TypeEnum type) {
    this.type = type;
    return this;
  }
  ...
  public Humidity value(@javax.annotation.Nonnull BigDecimal value) {
    this.value = value;
    return this;
  }
  ...
  public Humidity observedAt(@javax.annotation.Nullable OffsetDateTime observedAt) {
  ...
  public Humidity unitCode(@javax.annotation.Nullable String unitCode) {
  ...
  public Humidity datasetId(@javax.annotation.Nullable URI datasetId) {
  ...
  public Humidity createdAt(@javax.annotation.Nullable OffsetDateTime createdAt) {
  ...
  public Humidity modifiedAt(@javax.annotation.Nullable OffsetDateTime modifiedAt) {
  ...
  public Humidity deletedAt(@javax.annotation.Nullable OffsetDateTime deletedAt) {
  ...
  public Humidity previousValue(@javax.annotation.Nullable PropertyPreviousValue previousValue) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.type, humidity.type) &&
        Objects.equals(this.value, humidity.value) &&
        Objects.equals(this.observedAt, humidity.observedAt) &&
        Objects.equals(this.unitCode, humidity.unitCode) &&
        Objects.equals(this.datasetId, humidity.datasetId) &&
        Objects.equals(this.createdAt, humidity.createdAt) &&
        Objects.equals(this.modifiedAt, humidity.modifiedAt) &&
        Objects.equals(this.deletedAt, humidity.deletedAt) &&
        Objects.equals(this.instanceId, humidity.instanceId) &&
        Objects.equals(this.previousValue, humidity.previousValue);
  }
   ...
   * @throws IOException if the JSON Element is invalid with respect to Humidity
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!Humidity.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in Humidity is not found in the empty JSON string", Humidity.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!Humidity.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `Humidity` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : Humidity.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!Humidity.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'Humidity' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<Humidity> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(Humidity.class));

       return (TypeAdapter<T>) new TypeAdapter<Humidity>() {
           @Override
  ...
  /**
   * Create an instance of Humidity given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of Humidity
   * @throws IOException if the JSON string is invalid with respect to Humidity
   */
  public static Humidity fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, Humidity.class);
  }

  /**
   * Convert an instance of Humidity to an JSON string
   *
   * @return JSON string
   */
