...
public class TemporalQueryBatchRequest {
  /**
   * JSON-LD @type. 
   */
  ...
  public TemporalQueryBatchRequest() {
  }

  public TemporalQueryBatchRequest type(@javax.annotation.Nonnull TypeEnum type) {
    this.type = type;
    return this;
  }
  ...
  public TemporalQueryBatchRequest entities(@javax.annotation.Nullable List<EntitySelector> entities) {
    this.entities = entities;
    return this;
  }

  public TemporalQueryBatchRequest addEntitiesItem(EntitySelector entitiesItem) {
  ...
  public TemporalQueryBatchRequest attrs(@javax.annotation.Nullable List<String> attrs) {
    this.attrs = attrs;
    return this;
  }

  public TemporalQueryBatchRequest addAttrsItem(String attrsItem) {
    if (this.attrs == null) {
  ...
  public TemporalQueryBatchRequest q(@javax.annotation.Nullable String q) {
    this.q = q;
    return this;
  }
  ...
  public TemporalQueryBatchRequest geoQ(@javax.annotation.Nullable GeoQuery geoQ) {
    this.geoQ = geoQ;
    return this;
  }
  ...
  public TemporalQueryBatchRequest csf(@javax.annotation.Nullable String csf) {
    this.csf = csf;
    return this;
  }
  ...
  public TemporalQueryBatchRequest scopeQ(@javax.annotation.Nullable String scopeQ) {
    this.scopeQ = scopeQ;
    return this;
  }
  ...
  public TemporalQueryBatchRequest lang(@javax.annotation.Nullable String lang) {
    this.lang = lang;
    return this;
  }
  ...
  public TemporalQueryBatchRequest temporalQ(@javax.annotation.Nonnull TemporalQuery temporalQ) {
  ...
  public TemporalQueryBatchRequest atContext(@javax.annotation.Nonnull LdContext atContext) {
   ...
   * @return the TemporalQueryBatchRequest instance itself
   */
  public TemporalQueryBatchRequest putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    TemporalQueryBatchRequest temporalQueryBatchRequest = (TemporalQueryBatchRequest) o;
    return Objects.equals(this.type, temporalQueryBatchRequest.type) &&
        Objects.equals(this.entities, temporalQueryBatchRequest.entities) &&
        Objects.equals(this.attrs, temporalQueryBatchRequest.attrs) &&
        Objects.equals(this.q, temporalQueryBatchRequest.q) &&
        Objects.equals(this.geoQ, temporalQueryBatchRequest.geoQ) &&
        Objects.equals(this.csf, temporalQueryBatchRequest.csf) &&
        Objects.equals(this.scopeQ, temporalQueryBatchRequest.scopeQ) &&
        Objects.equals(this.lang, temporalQueryBatchRequest.lang) &&
        Objects.equals(this.temporalQ, temporalQueryBatchRequest.temporalQ) &&
        Objects.equals(this.atContext, temporalQueryBatchRequest.atContext)&&
        Objects.equals(this.additionalProperties, temporalQueryBatchRequest.additionalProperties);
  }

  @Override
  public int hashCode() {
    return Objects.hash(type, entities, attrs, q, geoQ, csf, scopeQ, lang, temporalQ, atContext, additionalProperties);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class TemporalQueryBatchRequest {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to TemporalQueryBatchRequest
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!TemporalQueryBatchRequest.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in TemporalQueryBatchRequest is not found in the empty JSON string", TemporalQueryBatchRequest.openapiRequiredFields.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : TemporalQueryBatchRequest.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!TemporalQueryBatchRequest.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'TemporalQueryBatchRequest' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<TemporalQueryBatchRequest> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(TemporalQueryBatchRequest.class));

       return (TypeAdapter<T>) new TypeAdapter<TemporalQueryBatchRequest>() {
           @Override
           public void write(JsonWriter out, TemporalQueryBatchRequest value) throws IOException {
           ...
           @Override
           public TemporalQueryBatchRequest read(JsonReader in) throws IOException {
             JsonElement jsonElement = elementAdapter.read(in);
             validateJsonElement(jsonElement);
             JsonObject jsonObj = jsonElement.getAsJsonObject();
             // store additional fields in the deserialized instance
             TemporalQueryBatchRequest instance = thisAdapter.fromJsonTree(jsonObj);
  ...
  /**
   * Create an instance of TemporalQueryBatchRequest given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of TemporalQueryBatchRequest
   * @throws IOException if the JSON string is invalid with respect to TemporalQueryBatchRequest
   */
  public static TemporalQueryBatchRequest fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, TemporalQueryBatchRequest.class);
  }

  /**
   * Convert an instance of TemporalQueryBatchRequest to an JSON string
   *
   * @return JSON string
   */
