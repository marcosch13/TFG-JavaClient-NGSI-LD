...
public class QuerySubscription200ResponseInner1 {
  ...
  public QuerySubscription200ResponseInner1() {
  }
  ...
  public QuerySubscription200ResponseInner1 id(@javax.annotation.Nonnull URI id) {
    this.id = id;
    return this;
  }
  ...
  public QuerySubscription200ResponseInner1 type(@javax.annotation.Nonnull TypeEnum type) {
    this.type = type;
    return this;
  }
  ...
  public QuerySubscription200ResponseInner1 subscriptionName(@javax.annotation.Nullable String subscriptionName) {
  ...
  public QuerySubscription200ResponseInner1 description(@javax.annotation.Nullable String description) {
  ...
  public QuerySubscription200ResponseInner1 entities(@javax.annotation.Nullable List<EntitySelector> entities) {
    this.entities = entities;
    return this;
  }

  public QuerySubscription200ResponseInner1 addEntitiesItem(EntitySelector entitiesItem) {
  ...
  public QuerySubscription200ResponseInner1 notificationTrigger(@javax.annotation.Nullable List<NotificationTriggerEnum> notificationTrigger) {
    this.notificationTrigger = notificationTrigger;
    return this;
  }

  public QuerySubscription200ResponseInner1 addNotificationTriggerItem(NotificationTriggerEnum notificationTriggerItem) {
  ...
  public QuerySubscription200ResponseInner1 q(@javax.annotation.Nullable String q) {
    this.q = q;
    return this;
  }
  ...
  public QuerySubscription200ResponseInner1 geoQ(@javax.annotation.Nullable GeoQuery geoQ) {
    this.geoQ = geoQ;
    return this;
  }
  ...
  public QuerySubscription200ResponseInner1 csf(@javax.annotation.Nullable String csf) {
    this.csf = csf;
    return this;
  }
  ...
  public QuerySubscription200ResponseInner1 isActive(@javax.annotation.Nullable Boolean isActive) {
  ...
  public QuerySubscription200ResponseInner1 notification(@javax.annotation.Nonnull NotificationParams notification) {
  ...
  public QuerySubscription200ResponseInner1 expiresAt(@javax.annotation.Nullable OffsetDateTime expiresAt) {
  ...
  public QuerySubscription200ResponseInner1 temporalQ(@javax.annotation.Nullable TemporalQuery temporalQ) {
  ...
  public QuerySubscription200ResponseInner1 scopeQ(@javax.annotation.Nullable String scopeQ) {
    this.scopeQ = scopeQ;
    return this;
  }
  ...
  public QuerySubscription200ResponseInner1 lang(@javax.annotation.Nullable String lang) {
    this.lang = lang;
    return this;
  }
  ...
  public QuerySubscription200ResponseInner1 createdAt(@javax.annotation.Nullable OffsetDateTime createdAt) {
  ...
  public QuerySubscription200ResponseInner1 modifiedAt(@javax.annotation.Nullable OffsetDateTime modifiedAt) {
  ...
  public QuerySubscription200ResponseInner1 deletedAt(@javax.annotation.Nullable OffsetDateTime deletedAt) {
  ...
  public QuerySubscription200ResponseInner1 jsonldContext(@javax.annotation.Nullable URI jsonldContext) {
  ...
  public QuerySubscription200ResponseInner1 watchedAttributes(@javax.annotation.Nullable List<String> watchedAttributes) {
    this.watchedAttributes = watchedAttributes;
    return this;
  }

  public QuerySubscription200ResponseInner1 addWatchedAttributesItem(String watchedAttributesItem) {
  ...
  public QuerySubscription200ResponseInner1 throttling(@javax.annotation.Nullable BigDecimal throttling) {
  ...
  public QuerySubscription200ResponseInner1 timeInterval(@javax.annotation.Nullable BigDecimal timeInterval) {
  ...
  public QuerySubscription200ResponseInner1 atContext(@javax.annotation.Nonnull LdContext atContext) {
   ...
   * @return the QuerySubscription200ResponseInner1 instance itself
   */
  public QuerySubscription200ResponseInner1 putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    QuerySubscription200ResponseInner1 querySubscription200ResponseInner1 = (QuerySubscription200ResponseInner1) o;
    return Objects.equals(this.id, querySubscription200ResponseInner1.id) &&
        Objects.equals(this.type, querySubscription200ResponseInner1.type) &&
        Objects.equals(this.subscriptionName, querySubscription200ResponseInner1.subscriptionName) &&
        Objects.equals(this.description, querySubscription200ResponseInner1.description) &&
        Objects.equals(this.entities, querySubscription200ResponseInner1.entities) &&
        Objects.equals(this.notificationTrigger, querySubscription200ResponseInner1.notificationTrigger) &&
        Objects.equals(this.q, querySubscription200ResponseInner1.q) &&
        Objects.equals(this.geoQ, querySubscription200ResponseInner1.geoQ) &&
        Objects.equals(this.csf, querySubscription200ResponseInner1.csf) &&
        Objects.equals(this.isActive, querySubscription200ResponseInner1.isActive) &&
        Objects.equals(this.notification, querySubscription200ResponseInner1.notification) &&
        Objects.equals(this.expiresAt, querySubscription200ResponseInner1.expiresAt) &&
        Objects.equals(this.temporalQ, querySubscription200ResponseInner1.temporalQ) &&
        Objects.equals(this.scopeQ, querySubscription200ResponseInner1.scopeQ) &&
        Objects.equals(this.lang, querySubscription200ResponseInner1.lang) &&
        Objects.equals(this.createdAt, querySubscription200ResponseInner1.createdAt) &&
        Objects.equals(this.modifiedAt, querySubscription200ResponseInner1.modifiedAt) &&
        Objects.equals(this.deletedAt, querySubscription200ResponseInner1.deletedAt) &&
        Objects.equals(this.status, querySubscription200ResponseInner1.status) &&
        Objects.equals(this.jsonldContext, querySubscription200ResponseInner1.jsonldContext) &&
        Objects.equals(this.watchedAttributes, querySubscription200ResponseInner1.watchedAttributes) &&
        Objects.equals(this.throttling, querySubscription200ResponseInner1.throttling) &&
        Objects.equals(this.timeInterval, querySubscription200ResponseInner1.timeInterval) &&
        Objects.equals(this.atContext, querySubscription200ResponseInner1.atContext)&&
        Objects.equals(this.additionalProperties, querySubscription200ResponseInner1.additionalProperties);
  }
  ...
  public String toString() {
    ...
    sb.append("class QuerySubscription200ResponseInner1 {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to QuerySubscription200ResponseInner1
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!QuerySubscription200ResponseInner1.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in QuerySubscription200ResponseInner1 is not found in the empty JSON string", QuerySubscription200ResponseInner1.openapiRequiredFields.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : QuerySubscription200ResponseInner1.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!QuerySubscription200ResponseInner1.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'QuerySubscription200ResponseInner1' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<QuerySubscription200ResponseInner1> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(QuerySubscription200ResponseInner1.class));

       return (TypeAdapter<T>) new TypeAdapter<QuerySubscription200ResponseInner1>() {
           @Override
           public void write(JsonWriter out, QuerySubscription200ResponseInner1 value) throws IOException {
           ...
           @Override
           public QuerySubscription200ResponseInner1 read(JsonReader in) throws IOException {
             JsonElement jsonElement = elementAdapter.read(in);
             validateJsonElement(jsonElement);
             JsonObject jsonObj = jsonElement.getAsJsonObject();
             // store additional fields in the deserialized instance
             QuerySubscription200ResponseInner1 instance = thisAdapter.fromJsonTree(jsonObj);
  ...
  /**
   * Create an instance of QuerySubscription200ResponseInner1 given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of QuerySubscription200ResponseInner1
   * @throws IOException if the JSON string is invalid with respect to QuerySubscription200ResponseInner1
   */
  public static QuerySubscription200ResponseInner1 fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, QuerySubscription200ResponseInner1.class);
  }

  /**
   * Convert an instance of QuerySubscription200ResponseInner1 to an JSON string
   *
   * @return JSON string
   */
