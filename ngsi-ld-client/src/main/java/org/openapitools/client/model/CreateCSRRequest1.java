...
public class CreateCSRRequest1 {
  ...
  public CreateCSRRequest1 id(@javax.annotation.Nullable URI id) {
    this.id = id;
    return this;
  }
  ...
  public CreateCSRRequest1 type(@javax.annotation.Nonnull TypeEnum type) {
    this.type = type;
    return this;
  }
  ...
  public CreateCSRRequest1 registrationName(@javax.annotation.Nullable String registrationName) {
  ...
  public CreateCSRRequest1 description(@javax.annotation.Nullable String description) {
  ...
  public CreateCSRRequest1 information(@javax.annotation.Nonnull List<RegistrationInfo> information) {
    this.information = information;
    return this;
  }

  public CreateCSRRequest1 addInformationItem(RegistrationInfo informationItem) {
  ...
  public CreateCSRRequest1 tenant(@javax.annotation.Nullable String tenant) {
    this.tenant = tenant;
    return this;
  }
  ...
  public CreateCSRRequest1 observationInterval(@javax.annotation.Nullable TimeInterval observationInterval) {
  ...
  public CreateCSRRequest1 managementInterval(@javax.annotation.Nullable TimeInterval managementInterval) {
  ...
  public CreateCSRRequest1 location(@javax.annotation.Nullable Geometry location) {
  ...
  public CreateCSRRequest1 observationSpace(@javax.annotation.Nullable Geometry observationSpace) {
  ...
  public CreateCSRRequest1 operationSpace(@javax.annotation.Nullable Geometry operationSpace) {
  ...
  public CreateCSRRequest1 expiresAt(@javax.annotation.Nullable OffsetDateTime expiresAt) {
  ...
  public CreateCSRRequest1 endpoint(@javax.annotation.Nonnull URI endpoint) {
  ...
  public CreateCSRRequest1 contextSourceInfo(@javax.annotation.Nullable List<KeyValuePair> contextSourceInfo) {
    this.contextSourceInfo = contextSourceInfo;
    return this;
  }

  public CreateCSRRequest1 addContextSourceInfoItem(KeyValuePair contextSourceInfoItem) {
  ...
  public CreateCSRRequest1 scope(@javax.annotation.Nullable CsourceRegistrationScope scope) {
    this.scope = scope;
    return this;
  }
  ...
  public CreateCSRRequest1 mode(@javax.annotation.Nullable ModeEnum mode) {
    this.mode = mode;
    return this;
  }
  ...
  public CreateCSRRequest1 operations(@javax.annotation.Nullable List<String> operations) {
    this.operations = operations;
    return this;
  }

  public CreateCSRRequest1 addOperationsItem(String operationsItem) {
  ...
  public CreateCSRRequest1 refreshRate(@javax.annotation.Nullable String refreshRate) {
  ...
  public CreateCSRRequest1 management(@javax.annotation.Nullable RegistrationManagementInfo management) {
  ...
  public CreateCSRRequest1 createdAt(@javax.annotation.Nullable OffsetDateTime createdAt) {
  ...
  public CreateCSRRequest1 modifiedAt(@javax.annotation.Nullable OffsetDateTime modifiedAt) {
  ...
  public CreateCSRRequest1 deletedAt(@javax.annotation.Nullable OffsetDateTime deletedAt) {
  ...
  public CreateCSRRequest1 atContext(@javax.annotation.Nonnull LdContext atContext) {
   ...
   * @return the CreateCSRRequest1 instance itself
   */
  public CreateCSRRequest1 putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    CreateCSRRequest1 createCSRRequest1 = (CreateCSRRequest1) o;
    return Objects.equals(this.id, createCSRRequest1.id) &&
        Objects.equals(this.type, createCSRRequest1.type) &&
        Objects.equals(this.registrationName, createCSRRequest1.registrationName) &&
        Objects.equals(this.description, createCSRRequest1.description) &&
        Objects.equals(this.information, createCSRRequest1.information) &&
        Objects.equals(this.tenant, createCSRRequest1.tenant) &&
        Objects.equals(this.observationInterval, createCSRRequest1.observationInterval) &&
        Objects.equals(this.managementInterval, createCSRRequest1.managementInterval) &&
        Objects.equals(this.location, createCSRRequest1.location) &&
        Objects.equals(this.observationSpace, createCSRRequest1.observationSpace) &&
        Objects.equals(this.operationSpace, createCSRRequest1.operationSpace) &&
        Objects.equals(this.expiresAt, createCSRRequest1.expiresAt) &&
        Objects.equals(this.endpoint, createCSRRequest1.endpoint) &&
        Objects.equals(this.contextSourceInfo, createCSRRequest1.contextSourceInfo) &&
        Objects.equals(this.scope, createCSRRequest1.scope) &&
        Objects.equals(this.mode, createCSRRequest1.mode) &&
        Objects.equals(this.operations, createCSRRequest1.operations) &&
        Objects.equals(this.refreshRate, createCSRRequest1.refreshRate) &&
        Objects.equals(this.management, createCSRRequest1.management) &&
        Objects.equals(this.createdAt, createCSRRequest1.createdAt) &&
        Objects.equals(this.modifiedAt, createCSRRequest1.modifiedAt) &&
        Objects.equals(this.deletedAt, createCSRRequest1.deletedAt) &&
        Objects.equals(this.status, createCSRRequest1.status) &&
        Objects.equals(this.timesSent, createCSRRequest1.timesSent) &&
        Objects.equals(this.timesFailed, createCSRRequest1.timesFailed) &&
        Objects.equals(this.lastSuccess, createCSRRequest1.lastSuccess) &&
        Objects.equals(this.lastFailure, createCSRRequest1.lastFailure) &&
        Objects.equals(this.atContext, createCSRRequest1.atContext)&&
        Objects.equals(this.additionalProperties, createCSRRequest1.additionalProperties);
  }
  ...
  public String toString() {
    ...
    sb.append("class CreateCSRRequest1 {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to CreateCSRRequest1
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!CreateCSRRequest1.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in CreateCSRRequest1 is not found in the empty JSON string", CreateCSRRequest1.openapiRequiredFields.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : CreateCSRRequest1.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!CreateCSRRequest1.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'CreateCSRRequest1' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<CreateCSRRequest1> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(CreateCSRRequest1.class));

       return (TypeAdapter<T>) new TypeAdapter<CreateCSRRequest1>() {
           @Override
           public void write(JsonWriter out, CreateCSRRequest1 value) throws IOException {
           ...
           @Override
           public CreateCSRRequest1 read(JsonReader in) throws IOException {
             JsonElement jsonElement = elementAdapter.read(in);
             validateJsonElement(jsonElement);
             JsonObject jsonObj = jsonElement.getAsJsonObject();
             // store additional fields in the deserialized instance
             CreateCSRRequest1 instance = thisAdapter.fromJsonTree(jsonObj);
  ...
  /**
   * Create an instance of CreateCSRRequest1 given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of CreateCSRRequest1
   * @throws IOException if the JSON string is invalid with respect to CreateCSRRequest1
   */
  public static CreateCSRRequest1 fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, CreateCSRRequest1.class);
  }

  /**
   * Convert an instance of CreateCSRRequest1 to an JSON string
   *
   * @return JSON string
   */
