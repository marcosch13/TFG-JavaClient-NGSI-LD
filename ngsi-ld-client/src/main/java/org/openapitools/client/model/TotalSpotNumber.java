...
public class TotalSpotNumber {
  ...
  public TotalSpotNumber type(@javax.annotation.Nullable TypeEnum type) {
    this.type = type;
    return this;
  }
  ...
  public TotalSpotNumber value(@javax.annotation.Nonnull BigDecimal value) {
    this.value = value;
    return this;
  }
  ...
  public TotalSpotNumber observedAt(@javax.annotation.Nullable OffsetDateTime observedAt) {
  ...
  public TotalSpotNumber unitCode(@javax.annotation.Nullable String unitCode) {
  ...
  public TotalSpotNumber datasetId(@javax.annotation.Nullable URI datasetId) {
  ...
  public TotalSpotNumber createdAt(@javax.annotation.Nullable OffsetDateTime createdAt) {
  ...
  public TotalSpotNumber modifiedAt(@javax.annotation.Nullable OffsetDateTime modifiedAt) {
  ...
  public TotalSpotNumber deletedAt(@javax.annotation.Nullable OffsetDateTime deletedAt) {
  ...
  public TotalSpotNumber previousValue(@javax.annotation.Nullable PropertyPreviousValue previousValue) {
  ...
  public boolean equals(Object o) {
    ...
    TotalSpotNumber totalSpotNumber = (TotalSpotNumber) o;
    return Objects.equals(this.type, totalSpotNumber.type) &&
        Objects.equals(this.value, totalSpotNumber.value) &&
        Objects.equals(this.observedAt, totalSpotNumber.observedAt) &&
        Objects.equals(this.unitCode, totalSpotNumber.unitCode) &&
        Objects.equals(this.datasetId, totalSpotNumber.datasetId) &&
        Objects.equals(this.createdAt, totalSpotNumber.createdAt) &&
        Objects.equals(this.modifiedAt, totalSpotNumber.modifiedAt) &&
        Objects.equals(this.deletedAt, totalSpotNumber.deletedAt) &&
        Objects.equals(this.instanceId, totalSpotNumber.instanceId) &&
        Objects.equals(this.previousValue, totalSpotNumber.previousValue);
  }
  ...
  public String toString() {
    ...
    sb.append("class TotalSpotNumber {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to TotalSpotNumber
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!TotalSpotNumber.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in TotalSpotNumber is not found in the empty JSON string", TotalSpotNumber.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!TotalSpotNumber.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `TotalSpotNumber` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : TotalSpotNumber.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!TotalSpotNumber.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'TotalSpotNumber' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<TotalSpotNumber> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(TotalSpotNumber.class));

       return (TypeAdapter<T>) new TypeAdapter<TotalSpotNumber>() {
           @Override
           public void write(JsonWriter out, TotalSpotNumber value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public TotalSpotNumber read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of TotalSpotNumber given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of TotalSpotNumber
   * @throws IOException if the JSON string is invalid with respect to TotalSpotNumber
   */
  public static TotalSpotNumber fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, TotalSpotNumber.class);
  }

  /**
   * Convert an instance of TotalSpotNumber to an JSON string
   *
   * @return JSON string
   */
