...
public class QuerySubscription200ResponseInner {
  ...
  public QuerySubscription200ResponseInner() {
  }
  ...
  public QuerySubscription200ResponseInner id(@javax.annotation.Nonnull URI id) {
    this.id = id;
    return this;
  }
  ...
  public QuerySubscription200ResponseInner type(@javax.annotation.Nonnull TypeEnum type) {
    this.type = type;
    return this;
  }
  ...
  public QuerySubscription200ResponseInner subscriptionName(@javax.annotation.Nullable String subscriptionName) {
  ...
  public QuerySubscription200ResponseInner description(@javax.annotation.Nullable String description) {
  ...
  public QuerySubscription200ResponseInner entities(@javax.annotation.Nullable List<EntitySelector> entities) {
    this.entities = entities;
    return this;
  }

  public QuerySubscription200ResponseInner addEntitiesItem(EntitySelector entitiesItem) {
  ...
  public QuerySubscription200ResponseInner notificationTrigger(@javax.annotation.Nullable List<NotificationTriggerEnum> notificationTrigger) {
    this.notificationTrigger = notificationTrigger;
    return this;
  }

  public QuerySubscription200ResponseInner addNotificationTriggerItem(NotificationTriggerEnum notificationTriggerItem) {
  ...
  public QuerySubscription200ResponseInner q(@javax.annotation.Nullable String q) {
    this.q = q;
    return this;
  }
  ...
  public QuerySubscription200ResponseInner geoQ(@javax.annotation.Nullable GeoQuery geoQ) {
    this.geoQ = geoQ;
    return this;
  }
  ...
  public QuerySubscription200ResponseInner csf(@javax.annotation.Nullable String csf) {
    this.csf = csf;
    return this;
  }
  ...
  public QuerySubscription200ResponseInner isActive(@javax.annotation.Nullable Boolean isActive) {
  ...
  public QuerySubscription200ResponseInner notification(@javax.annotation.Nonnull NotificationParams notification) {
  ...
  public QuerySubscription200ResponseInner expiresAt(@javax.annotation.Nullable OffsetDateTime expiresAt) {
  ...
  public QuerySubscription200ResponseInner temporalQ(@javax.annotation.Nullable TemporalQuery temporalQ) {
  ...
  public QuerySubscription200ResponseInner scopeQ(@javax.annotation.Nullable String scopeQ) {
    this.scopeQ = scopeQ;
    return this;
  }
  ...
  public QuerySubscription200ResponseInner lang(@javax.annotation.Nullable String lang) {
    this.lang = lang;
    return this;
  }
  ...
  public QuerySubscription200ResponseInner createdAt(@javax.annotation.Nullable OffsetDateTime createdAt) {
  ...
  public QuerySubscription200ResponseInner modifiedAt(@javax.annotation.Nullable OffsetDateTime modifiedAt) {
  ...
  public QuerySubscription200ResponseInner deletedAt(@javax.annotation.Nullable OffsetDateTime deletedAt) {
  ...
  public QuerySubscription200ResponseInner jsonldContext(@javax.annotation.Nullable URI jsonldContext) {
  ...
  public QuerySubscription200ResponseInner watchedAttributes(@javax.annotation.Nullable List<String> watchedAttributes) {
    this.watchedAttributes = watchedAttributes;
    return this;
  }

  public QuerySubscription200ResponseInner addWatchedAttributesItem(String watchedAttributesItem) {
  ...
  public QuerySubscription200ResponseInner throttling(@javax.annotation.Nullable BigDecimal throttling) {
  ...
  public QuerySubscription200ResponseInner timeInterval(@javax.annotation.Nullable BigDecimal timeInterval) {
   ...
   * @return the QuerySubscription200ResponseInner instance itself
   */
  public QuerySubscription200ResponseInner putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    QuerySubscription200ResponseInner querySubscription200ResponseInner = (QuerySubscription200ResponseInner) o;
    return Objects.equals(this.id, querySubscription200ResponseInner.id) &&
        Objects.equals(this.type, querySubscription200ResponseInner.type) &&
        Objects.equals(this.subscriptionName, querySubscription200ResponseInner.subscriptionName) &&
        Objects.equals(this.description, querySubscription200ResponseInner.description) &&
        Objects.equals(this.entities, querySubscription200ResponseInner.entities) &&
        Objects.equals(this.notificationTrigger, querySubscription200ResponseInner.notificationTrigger) &&
        Objects.equals(this.q, querySubscription200ResponseInner.q) &&
        Objects.equals(this.geoQ, querySubscription200ResponseInner.geoQ) &&
        Objects.equals(this.csf, querySubscription200ResponseInner.csf) &&
        Objects.equals(this.isActive, querySubscription200ResponseInner.isActive) &&
        Objects.equals(this.notification, querySubscription200ResponseInner.notification) &&
        Objects.equals(this.expiresAt, querySubscription200ResponseInner.expiresAt) &&
        Objects.equals(this.temporalQ, querySubscription200ResponseInner.temporalQ) &&
        Objects.equals(this.scopeQ, querySubscription200ResponseInner.scopeQ) &&
        Objects.equals(this.lang, querySubscription200ResponseInner.lang) &&
        Objects.equals(this.createdAt, querySubscription200ResponseInner.createdAt) &&
        Objects.equals(this.modifiedAt, querySubscription200ResponseInner.modifiedAt) &&
        Objects.equals(this.deletedAt, querySubscription200ResponseInner.deletedAt) &&
        Objects.equals(this.status, querySubscription200ResponseInner.status) &&
        Objects.equals(this.jsonldContext, querySubscription200ResponseInner.jsonldContext) &&
        Objects.equals(this.watchedAttributes, querySubscription200ResponseInner.watchedAttributes) &&
        Objects.equals(this.throttling, querySubscription200ResponseInner.throttling) &&
        Objects.equals(this.timeInterval, querySubscription200ResponseInner.timeInterval)&&
        Objects.equals(this.additionalProperties, querySubscription200ResponseInner.additionalProperties);
  }

  @Override
  public int hashCode() {
    return Objects.hash(id, type, subscriptionName, description, entities, notificationTrigger, q, geoQ, csf, isActive, notification, expiresAt, temporalQ, scopeQ, lang, createdAt, modifiedAt, deletedAt, status, jsonldContext, watchedAttributes, throttling, timeInterval, additionalProperties);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class QuerySubscription200ResponseInner {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to QuerySubscription200ResponseInner
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!QuerySubscription200ResponseInner.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in QuerySubscription200ResponseInner is not found in the empty JSON string", QuerySubscription200ResponseInner.openapiRequiredFields.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : QuerySubscription200ResponseInner.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!QuerySubscription200ResponseInner.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'QuerySubscription200ResponseInner' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<QuerySubscription200ResponseInner> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(QuerySubscription200ResponseInner.class));

       return (TypeAdapter<T>) new TypeAdapter<QuerySubscription200ResponseInner>() {
           @Override
           public void write(JsonWriter out, QuerySubscription200ResponseInner value) throws IOException {
           ...
           @Override
           public QuerySubscription200ResponseInner read(JsonReader in) throws IOException {
             JsonElement jsonElement = elementAdapter.read(in);
             validateJsonElement(jsonElement);
             JsonObject jsonObj = jsonElement.getAsJsonObject();
             // store additional fields in the deserialized instance
             QuerySubscription200ResponseInner instance = thisAdapter.fromJsonTree(jsonObj);
  ...
  /**
   * Create an instance of QuerySubscription200ResponseInner given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of QuerySubscription200ResponseInner
   * @throws IOException if the JSON string is invalid with respect to QuerySubscription200ResponseInner
   */
  public static QuerySubscription200ResponseInner fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, QuerySubscription200ResponseInner.class);
  }

  /**
   * Convert an instance of QuerySubscription200ResponseInner to an JSON string
   *
   * @return JSON string
   */
