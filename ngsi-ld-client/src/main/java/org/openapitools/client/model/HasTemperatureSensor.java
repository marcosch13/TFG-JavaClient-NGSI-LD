...
public class HasTemperatureSensor {
  /**
   * Node type. 
   */
  ...
  public HasTemperatureSensor type(@javax.annotation.Nullable TypeEnum type) {
    this.type = type;
    return this;
  }
  ...
  public HasTemperatureSensor _object(@javax.annotation.Nonnull String _object) {
  ...
  public HasTemperatureSensor observedAt(@javax.annotation.Nullable OffsetDateTime observedAt) {
  ...
  public HasTemperatureSensor datasetId(@javax.annotation.Nullable URI datasetId) {
  ...
  public HasTemperatureSensor createdAt(@javax.annotation.Nullable OffsetDateTime createdAt) {
  ...
  public HasTemperatureSensor modifiedAt(@javax.annotation.Nullable OffsetDateTime modifiedAt) {
  ...
  public HasTemperatureSensor deletedAt(@javax.annotation.Nullable OffsetDateTime deletedAt) {
  ...
  public boolean equals(Object o) {
    ...
    HasTemperatureSensor hasTemperatureSensor = (HasTemperatureSensor) o;
    return Objects.equals(this.type, hasTemperatureSensor.type) &&
        Objects.equals(this._object, hasTemperatureSensor._object) &&
        Objects.equals(this.observedAt, hasTemperatureSensor.observedAt) &&
        Objects.equals(this.datasetId, hasTemperatureSensor.datasetId) &&
        Objects.equals(this.createdAt, hasTemperatureSensor.createdAt) &&
        Objects.equals(this.modifiedAt, hasTemperatureSensor.modifiedAt) &&
        Objects.equals(this.deletedAt, hasTemperatureSensor.deletedAt) &&
        Objects.equals(this.instanceId, hasTemperatureSensor.instanceId) &&
        Objects.equals(this.previousObject, hasTemperatureSensor.previousObject);
  }
  ...
  public String toString() {
    ...
    sb.append("class HasTemperatureSensor {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to HasTemperatureSensor
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!HasTemperatureSensor.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in HasTemperatureSensor is not found in the empty JSON string", HasTemperatureSensor.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!HasTemperatureSensor.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `HasTemperatureSensor` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : HasTemperatureSensor.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!HasTemperatureSensor.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'HasTemperatureSensor' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<HasTemperatureSensor> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(HasTemperatureSensor.class));

       return (TypeAdapter<T>) new TypeAdapter<HasTemperatureSensor>() {
           @Override
           public void write(JsonWriter out, HasTemperatureSensor value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public HasTemperatureSensor read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of HasTemperatureSensor given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of HasTemperatureSensor
   * @throws IOException if the JSON string is invalid with respect to HasTemperatureSensor
   */
  public static HasTemperatureSensor fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, HasTemperatureSensor.class);
  }

  /**
   * Convert an instance of HasTemperatureSensor to an JSON string
   *
   * @return JSON string
   */
