...
public class FeaturePropertiesValue extends AbstractOpenApiSchema {
    private static final Logger log = Logger.getLogger(FeaturePropertiesValue.class.getName());

    public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
        @SuppressWarnings("unchecked")
        @Override
        public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
            if (!FeaturePropertiesValue.class.isAssignableFrom(type.getRawType())) {
                return null; // this class only serializes 'FeaturePropertiesValue' and its subtypes
            }
            ...
            return (TypeAdapter<T>) new TypeAdapter<FeaturePropertiesValue>() {
                @Override
                public void write(JsonWriter out, FeaturePropertiesValue value) throws IOException {
                    ...
                    throw new IOException("Failed to serialize as the type doesn't match oneOf schemas: GeoProperty, LanguageProperty, List<GeoProperty>, List<LanguageProperty>, List<Property>, List<Relationship>, Property, Relationship");
                }

                @Override
                public FeaturePropertiesValue read(JsonReader in) throws IOException {
                    ...
                    if (match == 1) {
                        FeaturePropertiesValue ret = new FeaturePropertiesValue();
                        ret.setActualInstance(actualAdapter.fromJsonTree(jsonElement));
                        return ret;
                    }

                    throw new IOException(String.format("Failed deserialization for FeaturePropertiesValue: %d classes match result, expected 1. Detailed failure message for oneOf schemas: %s. JSON: %s", match, errorMessages, jsonElement.toString()));
                }
            }.nullSafe();
        }
    }
    ...
    public FeaturePropertiesValue() {
        super("oneOf", Boolean.FALSE);
    }

    public FeaturePropertiesValue(Object o) {
        super("oneOf", Boolean.FALSE);
        setActualInstance(o);
    }
    ...
    public Map<String, Class<?>> getSchemas() {
        return FeaturePropertiesValue.schemas;
    }

    /**
     * Set the instance that matches the oneOf child schema, check
     * the instance parameter is valid against the oneOf child schemas:
     * GeoProperty, LanguageProperty, List<GeoProperty>, List<LanguageProperty>, List<Property>, List<Relationship>, Property, Relationship
     *
    ...
    public void setActualInstance(Object instance) {
        ...
        throw new RuntimeException("Invalid instance type. Must be GeoProperty, LanguageProperty, List<GeoProperty>, List<LanguageProperty>, List<Property>, List<Relationship>, Property, Relationship");
    }
     ...
     * GeoProperty, LanguageProperty, List<GeoProperty>, List<LanguageProperty>, List<Property>, List<Relationship>, Property, Relationship
     *
     * @return The actual instance (GeoProperty, LanguageProperty, List<GeoProperty>, List<LanguageProperty>, List<Property>, List<Relationship>, Property, Relationship)
     */
    @SuppressWarnings("unchecked")
    @Override
     ...
     * @throws IOException if the JSON Element is invalid with respect to FeaturePropertiesValue
     */
    public static void validateJsonElement(JsonElement jsonElement) throws IOException {
        ...
        if (validCount != 1) {
            throw new IOException(String.format("The JSON string is invalid for FeaturePropertiesValue with oneOf schemas: GeoProperty, LanguageProperty, List<GeoProperty>, List<LanguageProperty>, List<Property>, List<Relationship>, Property, Relationship. %d class(es) match the result, expected 1. Detailed failure message for oneOf schemas: %s. JSON: %s", validCount, errorMessages, jsonElement.toString()));
        }
    }

    /**
     * Create an instance of FeaturePropertiesValue given an JSON string
     *
     * @param jsonString JSON string
     * @return An instance of FeaturePropertiesValue
     * @throws IOException if the JSON string is invalid with respect to FeaturePropertiesValue
     */
    public static FeaturePropertiesValue fromJson(String jsonString) throws IOException {
        return JSON.getGson().fromJson(jsonString, FeaturePropertiesValue.class);
    }

    /**
     * Convert an instance of FeaturePropertiesValue to an JSON string
     *
     * @return JSON string
     */
