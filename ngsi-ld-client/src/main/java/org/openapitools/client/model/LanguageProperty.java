...
public class LanguageProperty {
  ...
  public LanguageProperty type(@javax.annotation.Nullable TypeEnum type) {
    this.type = type;
    return this;
  }
  ...
  public LanguageProperty languageMap(@javax.annotation.Nullable Object languageMap) {
  ...
  public LanguageProperty observedAt(@javax.annotation.Nullable OffsetDateTime observedAt) {
  ...
  public LanguageProperty datasetId(@javax.annotation.Nullable URI datasetId) {
  ...
  public LanguageProperty createdAt(@javax.annotation.Nullable OffsetDateTime createdAt) {
  ...
  public LanguageProperty modifiedAt(@javax.annotation.Nullable OffsetDateTime modifiedAt) {
  ...
  public LanguageProperty deletedAt(@javax.annotation.Nullable OffsetDateTime deletedAt) {
   ...
   * @return the LanguageProperty instance itself
   */
  public LanguageProperty putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    LanguageProperty languageProperty = (LanguageProperty) o;
    return Objects.equals(this.type, languageProperty.type) &&
        Objects.equals(this.languageMap, languageProperty.languageMap) &&
        Objects.equals(this.observedAt, languageProperty.observedAt) &&
        Objects.equals(this.datasetId, languageProperty.datasetId) &&
        Objects.equals(this.createdAt, languageProperty.createdAt) &&
        Objects.equals(this.modifiedAt, languageProperty.modifiedAt) &&
        Objects.equals(this.deletedAt, languageProperty.deletedAt) &&
        Objects.equals(this.instanceId, languageProperty.instanceId) &&
        Objects.equals(this.previousLanguageMap, languageProperty.previousLanguageMap)&&
        Objects.equals(this.additionalProperties, languageProperty.additionalProperties);
  }

  @Override
  public int hashCode() {
    return Objects.hash(type, languageMap, observedAt, datasetId, createdAt, modifiedAt, deletedAt, instanceId, previousLanguageMap, additionalProperties);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class LanguageProperty {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to LanguageProperty
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!LanguageProperty.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in LanguageProperty is not found in the empty JSON string", LanguageProperty.openapiRequiredFields.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!LanguageProperty.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'LanguageProperty' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<LanguageProperty> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(LanguageProperty.class));

       return (TypeAdapter<T>) new TypeAdapter<LanguageProperty>() {
           @Override
           public void write(JsonWriter out, LanguageProperty value) throws IOException {
           ...
           @Override
           public LanguageProperty read(JsonReader in) throws IOException {
             JsonElement jsonElement = elementAdapter.read(in);
             validateJsonElement(jsonElement);
             JsonObject jsonObj = jsonElement.getAsJsonObject();
             // store additional fields in the deserialized instance
             LanguageProperty instance = thisAdapter.fromJsonTree(jsonObj);
  ...
  /**
   * Create an instance of LanguageProperty given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of LanguageProperty
   * @throws IOException if the JSON string is invalid with respect to LanguageProperty
   */
  public static LanguageProperty fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, LanguageProperty.class);
  }

  /**
   * Convert an instance of LanguageProperty to an JSON string
   *
   * @return JSON string
   */
