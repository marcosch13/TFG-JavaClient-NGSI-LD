...
public class EntityInfo {
  ...
  private EntityInfoType type;

  public EntityInfo() {
  }

  public EntityInfo id(@javax.annotation.Nullable URI id) {
    this.id = id;
    return this;
  }
  ...
  public EntityInfo idPattern(@javax.annotation.Nullable String idPattern) {
  ...
  public EntityInfo type(@javax.annotation.Nonnull EntityInfoType type) {
    this.type = type;
    return this;
  }
   ...
   */
  @javax.annotation.Nonnull
  public EntityInfoType getType() {
    return type;
  }

  public void setType(@javax.annotation.Nonnull EntityInfoType type) {
    this.type = type;
  }
   ...
   * @return the EntityInfo instance itself
   */
  public EntityInfo putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.id, entityInfo.id) &&
        Objects.equals(this.idPattern, entityInfo.idPattern) &&
        Objects.equals(this.type, entityInfo.type)&&
        Objects.equals(this.additionalProperties, entityInfo.additionalProperties);
  }
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      ...
      EntityInfoType.validateJsonElement(jsonObj.get("type"));
  }
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       ...
       return (TypeAdapter<T>) new TypeAdapter<EntityInfo>() {
           ...
           public EntityInfo read(JsonReader in) throws IOException {
             ...
             EntityInfo instance = thisAdapter.fromJsonTree(jsonObj);
