...
public class consola{
    ...
    public static void main(String[] args){
        ...
        while(opcion != 0){
            ...
            System.out.println("14:Crear suscripción basada en cambios");
            System.out.println("15:Crear suscripción periódica");
            System.out.println("16:Consultar suscripciones");
            ...
            if(opcion == 1){
                ...
                System.out.println("Crear suscripción basada en cambios en los sensores");
                OnChangeSuscription.main(null);
            }else if(opcion == 15) {
