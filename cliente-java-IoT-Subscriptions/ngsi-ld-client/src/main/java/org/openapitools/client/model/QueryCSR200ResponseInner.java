...
public class QueryCSR200ResponseInner {
  ...
  public QueryCSR200ResponseInner() {
  }
  ...
  public QueryCSR200ResponseInner id(@javax.annotation.Nonnull URI id) {
    this.id = id;
    return this;
  }
  ...
  public QueryCSR200ResponseInner type(@javax.annotation.Nonnull TypeEnum type) {
    this.type = type;
    return this;
  }
  ...
  public QueryCSR200ResponseInner registrationName(@javax.annotation.Nullable String registrationName) {
  ...
  public QueryCSR200ResponseInner description(@javax.annotation.Nullable String description) {
  ...
  public QueryCSR200ResponseInner information(@javax.annotation.Nonnull List<RegistrationInfo> information) {
    this.information = information;
    return this;
  }

  public QueryCSR200ResponseInner addInformationItem(RegistrationInfo informationItem) {
  ...
  public QueryCSR200ResponseInner tenant(@javax.annotation.Nullable String tenant) {
    this.tenant = tenant;
    return this;
  }
  ...
  public QueryCSR200ResponseInner observationInterval(@javax.annotation.Nullable TimeInterval observationInterval) {
  ...
  public QueryCSR200ResponseInner managementInterval(@javax.annotation.Nullable TimeInterval managementInterval) {
  ...
  public QueryCSR200ResponseInner location(@javax.annotation.Nullable Geometry location) {
  ...
  public QueryCSR200ResponseInner observationSpace(@javax.annotation.Nullable Geometry observationSpace) {
  ...
  public QueryCSR200ResponseInner operationSpace(@javax.annotation.Nullable Geometry operationSpace) {
  ...
  public QueryCSR200ResponseInner expiresAt(@javax.annotation.Nullable OffsetDateTime expiresAt) {
  ...
  public QueryCSR200ResponseInner endpoint(@javax.annotation.Nonnull URI endpoint) {
  ...
  public QueryCSR200ResponseInner contextSourceInfo(@javax.annotation.Nullable List<KeyValuePair> contextSourceInfo) {
    this.contextSourceInfo = contextSourceInfo;
    return this;
  }

  public QueryCSR200ResponseInner addContextSourceInfoItem(KeyValuePair contextSourceInfoItem) {
  ...
  public QueryCSR200ResponseInner scope(@javax.annotation.Nullable CsourceRegistrationScope scope) {
    this.scope = scope;
    return this;
  }
  ...
  public QueryCSR200ResponseInner mode(@javax.annotation.Nullable ModeEnum mode) {
    this.mode = mode;
    return this;
  }
  ...
  public QueryCSR200ResponseInner operations(@javax.annotation.Nullable List<String> operations) {
    this.operations = operations;
    return this;
  }

  public QueryCSR200ResponseInner addOperationsItem(String operationsItem) {
  ...
  public QueryCSR200ResponseInner refreshRate(@javax.annotation.Nullable String refreshRate) {
  ...
  public QueryCSR200ResponseInner management(@javax.annotation.Nullable RegistrationManagementInfo management) {
  ...
  public QueryCSR200ResponseInner createdAt(@javax.annotation.Nullable OffsetDateTime createdAt) {
  ...
  public QueryCSR200ResponseInner modifiedAt(@javax.annotation.Nullable OffsetDateTime modifiedAt) {
  ...
  public QueryCSR200ResponseInner deletedAt(@javax.annotation.Nullable OffsetDateTime deletedAt) {
   ...
   * @return the QueryCSR200ResponseInner instance itself
   */
  public QueryCSR200ResponseInner putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    QueryCSR200ResponseInner queryCSR200ResponseInner = (QueryCSR200ResponseInner) o;
    return Objects.equals(this.id, queryCSR200ResponseInner.id) &&
        Objects.equals(this.type, queryCSR200ResponseInner.type) &&
        Objects.equals(this.registrationName, queryCSR200ResponseInner.registrationName) &&
        Objects.equals(this.description, queryCSR200ResponseInner.description) &&
        Objects.equals(this.information, queryCSR200ResponseInner.information) &&
        Objects.equals(this.tenant, queryCSR200ResponseInner.tenant) &&
        Objects.equals(this.observationInterval, queryCSR200ResponseInner.observationInterval) &&
        Objects.equals(this.managementInterval, queryCSR200ResponseInner.managementInterval) &&
        Objects.equals(this.location, queryCSR200ResponseInner.location) &&
        Objects.equals(this.observationSpace, queryCSR200ResponseInner.observationSpace) &&
        Objects.equals(this.operationSpace, queryCSR200ResponseInner.operationSpace) &&
        Objects.equals(this.expiresAt, queryCSR200ResponseInner.expiresAt) &&
        Objects.equals(this.endpoint, queryCSR200ResponseInner.endpoint) &&
        Objects.equals(this.contextSourceInfo, queryCSR200ResponseInner.contextSourceInfo) &&
        Objects.equals(this.scope, queryCSR200ResponseInner.scope) &&
        Objects.equals(this.mode, queryCSR200ResponseInner.mode) &&
        Objects.equals(this.operations, queryCSR200ResponseInner.operations) &&
        Objects.equals(this.refreshRate, queryCSR200ResponseInner.refreshRate) &&
        Objects.equals(this.management, queryCSR200ResponseInner.management) &&
        Objects.equals(this.createdAt, queryCSR200ResponseInner.createdAt) &&
        Objects.equals(this.modifiedAt, queryCSR200ResponseInner.modifiedAt) &&
        Objects.equals(this.deletedAt, queryCSR200ResponseInner.deletedAt) &&
        Objects.equals(this.status, queryCSR200ResponseInner.status) &&
        Objects.equals(this.timesSent, queryCSR200ResponseInner.timesSent) &&
        Objects.equals(this.timesFailed, queryCSR200ResponseInner.timesFailed) &&
        Objects.equals(this.lastSuccess, queryCSR200ResponseInner.lastSuccess) &&
        Objects.equals(this.lastFailure, queryCSR200ResponseInner.lastFailure)&&
        Objects.equals(this.additionalProperties, queryCSR200ResponseInner.additionalProperties);
  }

  @Override
  public int hashCode() {
    return Objects.hash(id, type, registrationName, description, information, tenant, observationInterval, managementInterval, location, observationSpace, operationSpace, expiresAt, endpoint, contextSourceInfo, scope, mode, operations, refreshRate, management, createdAt, modifiedAt, deletedAt, status, timesSent, timesFailed, lastSuccess, lastFailure, additionalProperties);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class QueryCSR200ResponseInner {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to QueryCSR200ResponseInner
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!QueryCSR200ResponseInner.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in QueryCSR200ResponseInner is not found in the empty JSON string", QueryCSR200ResponseInner.openapiRequiredFields.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : QueryCSR200ResponseInner.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!QueryCSR200ResponseInner.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'QueryCSR200ResponseInner' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<QueryCSR200ResponseInner> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(QueryCSR200ResponseInner.class));

       return (TypeAdapter<T>) new TypeAdapter<QueryCSR200ResponseInner>() {
           @Override
           public void write(JsonWriter out, QueryCSR200ResponseInner value) throws IOException {
           ...
           @Override
           public QueryCSR200ResponseInner read(JsonReader in) throws IOException {
             JsonElement jsonElement = elementAdapter.read(in);
             validateJsonElement(jsonElement);
             JsonObject jsonObj = jsonElement.getAsJsonObject();
             // store additional fields in the deserialized instance
             QueryCSR200ResponseInner instance = thisAdapter.fromJsonTree(jsonObj);
  ...
  /**
   * Create an instance of QueryCSR200ResponseInner given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of QueryCSR200ResponseInner
   * @throws IOException if the JSON string is invalid with respect to QueryCSR200ResponseInner
   */
  public static QueryCSR200ResponseInner fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, QueryCSR200ResponseInner.class);
  }

  /**
   * Convert an instance of QueryCSR200ResponseInner to an JSON string
   *
   * @return JSON string
   */
