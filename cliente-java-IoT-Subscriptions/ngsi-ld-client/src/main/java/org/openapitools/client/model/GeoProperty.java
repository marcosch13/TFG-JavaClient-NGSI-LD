...
public class GeoProperty {
  ...
  private TypeEnum type = TypeEnum.GEO_PROPERTY;
  ...
  public GeoProperty type(@javax.annotation.Nullable TypeEnum type) {
    this.type = type;
    return this;
  }
  ...
  public GeoProperty value(@javax.annotation.Nullable Geometry value) {
    this.value = value;
    return this;
  }
  ...
  public GeoProperty observedAt(@javax.annotation.Nullable OffsetDateTime observedAt) {
  ...
  public GeoProperty datasetId(@javax.annotation.Nullable URI datasetId) {
  ...
  public GeoProperty createdAt(@javax.annotation.Nullable OffsetDateTime createdAt) {
  ...
  public GeoProperty modifiedAt(@javax.annotation.Nullable OffsetDateTime modifiedAt) {
  ...
  public GeoProperty deletedAt(@javax.annotation.Nullable OffsetDateTime deletedAt) {
  ...
  public GeoProperty previousValue(@javax.annotation.Nullable Geometry previousValue) {
   ...
   * @return the GeoProperty instance itself
   */
  public GeoProperty putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    GeoProperty geoProperty = (GeoProperty) o;
    return Objects.equals(this.type, geoProperty.type) &&
        Objects.equals(this.value, geoProperty.value) &&
        Objects.equals(this.observedAt, geoProperty.observedAt) &&
        Objects.equals(this.datasetId, geoProperty.datasetId) &&
        Objects.equals(this.createdAt, geoProperty.createdAt) &&
        Objects.equals(this.modifiedAt, geoProperty.modifiedAt) &&
        Objects.equals(this.deletedAt, geoProperty.deletedAt) &&
        Objects.equals(this.instanceId, geoProperty.instanceId) &&
        Objects.equals(this.previousValue, geoProperty.previousValue)&&
        Objects.equals(this.additionalProperties, geoProperty.additionalProperties);
  }

  @Override
  public int hashCode() {
    return Objects.hash(type, value, observedAt, datasetId, createdAt, modifiedAt, deletedAt, instanceId, previousValue, additionalProperties);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class GeoProperty {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to GeoProperty
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!GeoProperty.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in GeoProperty is not found in the empty JSON string", GeoProperty.openapiRequiredFields.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!GeoProperty.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'GeoProperty' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<GeoProperty> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(GeoProperty.class));

       return (TypeAdapter<T>) new TypeAdapter<GeoProperty>() {
           @Override
           public void write(JsonWriter out, GeoProperty value) throws IOException {
           ...
           @Override
           public GeoProperty read(JsonReader in) throws IOException {
             JsonElement jsonElement = elementAdapter.read(in);
             validateJsonElement(jsonElement);
             JsonObject jsonObj = jsonElement.getAsJsonObject();
             // store additional fields in the deserialized instance
             GeoProperty instance = thisAdapter.fromJsonTree(jsonObj);
  ...
  /**
   * Create an instance of GeoProperty given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of GeoProperty
   * @throws IOException if the JSON string is invalid with respect to GeoProperty
   */
  public static GeoProperty fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, GeoProperty.class);
  }

  /**
   * Convert an instance of GeoProperty to an JSON string
   *
   * @return JSON string
   */
