...
public class IotDescription {
  ...
  public IotDescription type(@javax.annotation.Nullable TypeEnum type) {
    this.type = type;
    return this;
  }
  ...
  public IotDescription value(@javax.annotation.Nonnull String value) {
    this.value = value;
    return this;
  }
  ...
  public IotDescription observedAt(@javax.annotation.Nullable OffsetDateTime observedAt) {
  ...
  public IotDescription unitCode(@javax.annotation.Nullable String unitCode) {
  ...
  public IotDescription datasetId(@javax.annotation.Nullable URI datasetId) {
  ...
  public IotDescription createdAt(@javax.annotation.Nullable OffsetDateTime createdAt) {
  ...
  public IotDescription modifiedAt(@javax.annotation.Nullable OffsetDateTime modifiedAt) {
  ...
  public IotDescription deletedAt(@javax.annotation.Nullable OffsetDateTime deletedAt) {
  ...
  public IotDescription previousValue(@javax.annotation.Nullable PropertyPreviousValue previousValue) {
  ...
  public boolean equals(Object o) {
    ...
    IotDescription iotDescription = (IotDescription) o;
    return Objects.equals(this.type, iotDescription.type) &&
        Objects.equals(this.value, iotDescription.value) &&
        Objects.equals(this.observedAt, iotDescription.observedAt) &&
        Objects.equals(this.unitCode, iotDescription.unitCode) &&
        Objects.equals(this.datasetId, iotDescription.datasetId) &&
        Objects.equals(this.createdAt, iotDescription.createdAt) &&
        Objects.equals(this.modifiedAt, iotDescription.modifiedAt) &&
        Objects.equals(this.deletedAt, iotDescription.deletedAt) &&
        Objects.equals(this.instanceId, iotDescription.instanceId) &&
        Objects.equals(this.previousValue, iotDescription.previousValue);
  }
  ...
  public String toString() {
    ...
    sb.append("class IotDescription {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to IotDescription
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!IotDescription.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in IotDescription is not found in the empty JSON string", IotDescription.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!IotDescription.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `IotDescription` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : IotDescription.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!IotDescription.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'IotDescription' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<IotDescription> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(IotDescription.class));

       return (TypeAdapter<T>) new TypeAdapter<IotDescription>() {
           @Override
           public void write(JsonWriter out, IotDescription value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public IotDescription read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of IotDescription given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of IotDescription
   * @throws IOException if the JSON string is invalid with respect to IotDescription
   */
  public static IotDescription fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, IotDescription.class);
  }

  /**
   * Convert an instance of IotDescription to an JSON string
   *
   * @return JSON string
   */
