...
public class Camera {
  ...
  /**
   * NGSI-LD Entity identifier. It has to be Camera.
   */
  ...
  private TypeEnum type = TypeEnum.CAMERA;
  ...
  public Camera id(@javax.annotation.Nullable URI id) {
    this.id = id;
    return this;
  }
  ...
  public Camera type(@javax.annotation.Nonnull TypeEnum type) {
    this.type = type;
    return this;
  }
  ...
  public Camera scope(@javax.annotation.Nullable EntityScope scope) {
    this.scope = scope;
    return this;
  }
  ...
  public Camera location(@javax.annotation.Nullable GeoProperty location) {
  ...
  public Camera observationSpace(@javax.annotation.Nullable GeoProperty observationSpace) {
  ...
  public Camera operationSpace(@javax.annotation.Nullable GeoProperty operationSpace) {
  ...
  public Camera createdAt(@javax.annotation.Nullable OffsetDateTime createdAt) {
  ...
  public Camera modifiedAt(@javax.annotation.Nullable OffsetDateTime modifiedAt) {
  ...
  public Camera deletedAt(@javax.annotation.Nullable OffsetDateTime deletedAt) {
  ...
  public Camera name(@javax.annotation.Nonnull Name name) {
    this.name = name;
    return this;
  }
   ...
   * @return the Camera instance itself
   */
  public Camera putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.id, camera.id) &&
        Objects.equals(this.type, camera.type) &&
        Objects.equals(this.scope, camera.scope) &&
        Objects.equals(this.location, camera.location) &&
        Objects.equals(this.observationSpace, camera.observationSpace) &&
        Objects.equals(this.operationSpace, camera.operationSpace) &&
        Objects.equals(this.createdAt, camera.createdAt) &&
        Objects.equals(this.modifiedAt, camera.modifiedAt) &&
        Objects.equals(this.deletedAt, camera.deletedAt) &&
        Objects.equals(this.name, camera.name)&&
        Objects.equals(this.additionalProperties, camera.additionalProperties);
  }
   ...
   * @throws IOException if the JSON Element is invalid with respect to Camera
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!Camera.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in Camera is not found in the empty JSON string", Camera.openapiRequiredFields.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : Camera.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!Camera.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'Camera' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<Camera> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(Camera.class));

       return (TypeAdapter<T>) new TypeAdapter<Camera>() {
           @Override
           public void write(JsonWriter out, Camera value) throws IOException {
           ...
           @Override
           public Camera read(JsonReader in) throws IOException {
             JsonElement jsonElement = elementAdapter.read(in);
             validateJsonElement(jsonElement);
             JsonObject jsonObj = jsonElement.getAsJsonObject();
             // store additional fields in the deserialized instance
             Camera instance = thisAdapter.fromJsonTree(jsonObj);
  ...
  /**
   * Create an instance of Camera given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of Camera
   * @throws IOException if the JSON string is invalid with respect to Camera
   */
  public static Camera fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, Camera.class);
  }

  /**
   * Convert an instance of Camera to an JSON string
   *
   * @return JSON string
   */
