...
public class QueryBatchRequest {
  ...
  public QueryBatchRequest type(@javax.annotation.Nonnull TypeEnum type) {
    this.type = type;
    return this;
  }
  ...
  public QueryBatchRequest entities(@javax.annotation.Nullable List<EntitySelector> entities) {
    this.entities = entities;
    return this;
  }

  public QueryBatchRequest addEntitiesItem(EntitySelector entitiesItem) {
  ...
  public QueryBatchRequest attrs(@javax.annotation.Nullable List<String> attrs) {
    this.attrs = attrs;
    return this;
  }

  public QueryBatchRequest addAttrsItem(String attrsItem) {
    if (this.attrs == null) {
  ...
  public QueryBatchRequest q(@javax.annotation.Nullable String q) {
    this.q = q;
    return this;
  }
  ...
  public QueryBatchRequest geoQ(@javax.annotation.Nullable GeoQuery geoQ) {
    this.geoQ = geoQ;
    return this;
  }
  ...
  public QueryBatchRequest csf(@javax.annotation.Nullable String csf) {
    this.csf = csf;
    return this;
  }
  ...
  public QueryBatchRequest scopeQ(@javax.annotation.Nullable String scopeQ) {
    this.scopeQ = scopeQ;
    return this;
  }
  ...
  public QueryBatchRequest lang(@javax.annotation.Nullable String lang) {
    this.lang = lang;
    return this;
  }
  ...
  public QueryBatchRequest atContext(@javax.annotation.Nonnull LdContext atContext) {
   ...
   * @return the QueryBatchRequest instance itself
   */
  public QueryBatchRequest putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    QueryBatchRequest queryBatchRequest = (QueryBatchRequest) o;
    return Objects.equals(this.type, queryBatchRequest.type) &&
        Objects.equals(this.entities, queryBatchRequest.entities) &&
        Objects.equals(this.attrs, queryBatchRequest.attrs) &&
        Objects.equals(this.q, queryBatchRequest.q) &&
        Objects.equals(this.geoQ, queryBatchRequest.geoQ) &&
        Objects.equals(this.csf, queryBatchRequest.csf) &&
        Objects.equals(this.scopeQ, queryBatchRequest.scopeQ) &&
        Objects.equals(this.lang, queryBatchRequest.lang) &&
        Objects.equals(this.atContext, queryBatchRequest.atContext)&&
        Objects.equals(this.additionalProperties, queryBatchRequest.additionalProperties);
  }

  @Override
  public int hashCode() {
    return Objects.hash(type, entities, attrs, q, geoQ, csf, scopeQ, lang, atContext, additionalProperties);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class QueryBatchRequest {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to QueryBatchRequest
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!QueryBatchRequest.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in QueryBatchRequest is not found in the empty JSON string", QueryBatchRequest.openapiRequiredFields.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : QueryBatchRequest.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!QueryBatchRequest.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'QueryBatchRequest' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<QueryBatchRequest> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(QueryBatchRequest.class));

       return (TypeAdapter<T>) new TypeAdapter<QueryBatchRequest>() {
           @Override
           public void write(JsonWriter out, QueryBatchRequest value) throws IOException {
           ...
           @Override
           public QueryBatchRequest read(JsonReader in) throws IOException {
             JsonElement jsonElement = elementAdapter.read(in);
             validateJsonElement(jsonElement);
             JsonObject jsonObj = jsonElement.getAsJsonObject();
             // store additional fields in the deserialized instance
             QueryBatchRequest instance = thisAdapter.fromJsonTree(jsonObj);
  ...
  /**
   * Create an instance of QueryBatchRequest given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of QueryBatchRequest
   * @throws IOException if the JSON string is invalid with respect to QueryBatchRequest
   */
  public static QueryBatchRequest fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, QueryBatchRequest.class);
  }

  /**
   * Convert an instance of QueryBatchRequest to an JSON string
   *
   * @return JSON string
   */
