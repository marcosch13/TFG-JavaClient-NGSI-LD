...
import org.openapitools.client.model.EntityTemporalValue;
...
public class EntityTemporal {
  ...
  public EntityTemporal id(@javax.annotation.Nullable URI id) {
    this.id = id;
    return this;
  }
  ...
  public EntityTemporal type(@javax.annotation.Nullable EntityType type) {
    this.type = type;
    return this;
  }
  ...
  public EntityTemporal scope(@javax.annotation.Nullable EntityScope scope) {
    this.scope = scope;
    return this;
  }
  ...
  public EntityTemporal location(@javax.annotation.Nullable GeoProperty location) {
  ...
  public EntityTemporal observationSpace(@javax.annotation.Nullable GeoProperty observationSpace) {
  ...
  public EntityTemporal operationSpace(@javax.annotation.Nullable GeoProperty operationSpace) {
  ...
  public EntityTemporal createdAt(@javax.annotation.Nullable OffsetDateTime createdAt) {
  ...
  public EntityTemporal modifiedAt(@javax.annotation.Nullable OffsetDateTime modifiedAt) {
  ...
  public EntityTemporal deletedAt(@javax.annotation.Nullable OffsetDateTime deletedAt) {
   ...
   * @return the EntityTemporal instance itself
   */
  public EntityTemporal putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    EntityTemporal entityTemporal = (EntityTemporal) o;
    return Objects.equals(this.id, entityTemporal.id) &&
        Objects.equals(this.type, entityTemporal.type) &&
        Objects.equals(this.scope, entityTemporal.scope) &&
        Objects.equals(this.location, entityTemporal.location) &&
        Objects.equals(this.observationSpace, entityTemporal.observationSpace) &&
        Objects.equals(this.operationSpace, entityTemporal.operationSpace) &&
        Objects.equals(this.createdAt, entityTemporal.createdAt) &&
        Objects.equals(this.modifiedAt, entityTemporal.modifiedAt) &&
        Objects.equals(this.deletedAt, entityTemporal.deletedAt)&&
        Objects.equals(this.additionalProperties, entityTemporal.additionalProperties);
  }
  ...
  public String toString() {
    ...
    sb.append("class EntityTemporal {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to EntityTemporal
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!EntityTemporal.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in EntityTemporal is not found in the empty JSON string", EntityTemporal.openapiRequiredFields.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!EntityTemporal.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'EntityTemporal' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<EntityTemporal> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(EntityTemporal.class));

       return (TypeAdapter<T>) new TypeAdapter<EntityTemporal>() {
           @Override
           public void write(JsonWriter out, EntityTemporal value) throws IOException {
           ...
           @Override
           public EntityTemporal read(JsonReader in) throws IOException {
             JsonElement jsonElement = elementAdapter.read(in);
             validateJsonElement(jsonElement);
             JsonObject jsonObj = jsonElement.getAsJsonObject();
             // store additional fields in the deserialized instance
             EntityTemporal instance = thisAdapter.fromJsonTree(jsonObj);
  ...
  /**
   * Create an instance of EntityTemporal given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of EntityTemporal
   * @throws IOException if the JSON string is invalid with respect to EntityTemporal
   */
  public static EntityTemporal fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, EntityTemporal.class);
  }

  /**
   * Convert an instance of EntityTemporal to an JSON string
   *
   * @return JSON string
   */
