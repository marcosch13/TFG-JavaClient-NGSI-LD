...
public class ProvidedBy {
  ...
  public ProvidedBy type(@javax.annotation.Nullable TypeEnum type) {
    this.type = type;
    return this;
  }
  ...
  public ProvidedBy _object(@javax.annotation.Nonnull URI _object) {
  ...
  public ProvidedBy observedAt(@javax.annotation.Nullable OffsetDateTime observedAt) {
  ...
  public ProvidedBy datasetId(@javax.annotation.Nullable URI datasetId) {
  ...
  public ProvidedBy createdAt(@javax.annotation.Nullable OffsetDateTime createdAt) {
  ...
  public ProvidedBy modifiedAt(@javax.annotation.Nullable OffsetDateTime modifiedAt) {
  ...
  public ProvidedBy deletedAt(@javax.annotation.Nullable OffsetDateTime deletedAt) {
  ...
  public boolean equals(Object o) {
    ...
    ProvidedBy providedBy = (ProvidedBy) o;
    return Objects.equals(this.type, providedBy.type) &&
        Objects.equals(this._object, providedBy._object) &&
        Objects.equals(this.observedAt, providedBy.observedAt) &&
        Objects.equals(this.datasetId, providedBy.datasetId) &&
        Objects.equals(this.createdAt, providedBy.createdAt) &&
        Objects.equals(this.modifiedAt, providedBy.modifiedAt) &&
        Objects.equals(this.deletedAt, providedBy.deletedAt) &&
        Objects.equals(this.instanceId, providedBy.instanceId) &&
        Objects.equals(this.previousObject, providedBy.previousObject);
  }
   ...
   * @throws IOException if the JSON Element is invalid with respect to ProvidedBy
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!ProvidedBy.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in ProvidedBy is not found in the empty JSON string", ProvidedBy.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!ProvidedBy.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `ProvidedBy` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : ProvidedBy.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!ProvidedBy.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'ProvidedBy' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<ProvidedBy> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(ProvidedBy.class));

       return (TypeAdapter<T>) new TypeAdapter<ProvidedBy>() {
           @Override
           public void write(JsonWriter out, ProvidedBy value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public ProvidedBy read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of ProvidedBy given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of ProvidedBy
   * @throws IOException if the JSON string is invalid with respect to ProvidedBy
   */
  public static ProvidedBy fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, ProvidedBy.class);
  }

  /**
   * Convert an instance of ProvidedBy to an JSON string
   *
   * @return JSON string
   */
