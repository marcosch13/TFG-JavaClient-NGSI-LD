...
public class Name {
  ...
  public Name type(@javax.annotation.Nullable TypeEnum type) {
    this.type = type;
    return this;
  }
  ...
  public Name value(@javax.annotation.Nonnull String value) {
    this.value = value;
    return this;
  }
  ...
  public Name observedAt(@javax.annotation.Nullable OffsetDateTime observedAt) {
  ...
  public Name unitCode(@javax.annotation.Nullable String unitCode) {
  ...
  public Name datasetId(@javax.annotation.Nullable URI datasetId) {
  ...
  public Name createdAt(@javax.annotation.Nullable OffsetDateTime createdAt) {
  ...
  public Name modifiedAt(@javax.annotation.Nullable OffsetDateTime modifiedAt) {
  ...
  public Name deletedAt(@javax.annotation.Nullable OffsetDateTime deletedAt) {
  ...
  public Name previousValue(@javax.annotation.Nullable PropertyPreviousValue previousValue) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.type, name.type) &&
        ...
        Objects.equals(this.observedAt, name.observedAt) &&
        Objects.equals(this.unitCode, name.unitCode) &&
        Objects.equals(this.datasetId, name.datasetId) &&
        Objects.equals(this.createdAt, name.createdAt) &&
        Objects.equals(this.modifiedAt, name.modifiedAt) &&
        Objects.equals(this.deletedAt, name.deletedAt) &&
        Objects.equals(this.instanceId, name.instanceId) &&
        Objects.equals(this.previousValue, name.previousValue);
  }
