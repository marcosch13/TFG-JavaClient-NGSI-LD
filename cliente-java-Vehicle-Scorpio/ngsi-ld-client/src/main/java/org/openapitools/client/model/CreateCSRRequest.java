...
public class CreateCSRRequest {
  ...
  public CreateCSRRequest id(@javax.annotation.Nullable URI id) {
    this.id = id;
    return this;
  }
  ...
  public CreateCSRRequest type(@javax.annotation.Nonnull TypeEnum type) {
    this.type = type;
    return this;
  }
  ...
  public CreateCSRRequest registrationName(@javax.annotation.Nullable String registrationName) {
  ...
  public CreateCSRRequest description(@javax.annotation.Nullable String description) {
  ...
  public CreateCSRRequest information(@javax.annotation.Nonnull List<RegistrationInfo> information) {
    this.information = information;
    return this;
  }

  public CreateCSRRequest addInformationItem(RegistrationInfo informationItem) {
  ...
  public CreateCSRRequest tenant(@javax.annotation.Nullable String tenant) {
    this.tenant = tenant;
    return this;
  }
  ...
  public CreateCSRRequest observationInterval(@javax.annotation.Nullable TimeInterval observationInterval) {
  ...
  public CreateCSRRequest managementInterval(@javax.annotation.Nullable TimeInterval managementInterval) {
  ...
  public CreateCSRRequest location(@javax.annotation.Nullable Geometry location) {
  ...
  public CreateCSRRequest observationSpace(@javax.annotation.Nullable Geometry observationSpace) {
  ...
  public CreateCSRRequest operationSpace(@javax.annotation.Nullable Geometry operationSpace) {
  ...
  public CreateCSRRequest expiresAt(@javax.annotation.Nullable OffsetDateTime expiresAt) {
  ...
  public CreateCSRRequest endpoint(@javax.annotation.Nonnull URI endpoint) {
  ...
  public CreateCSRRequest contextSourceInfo(@javax.annotation.Nullable List<KeyValuePair> contextSourceInfo) {
    this.contextSourceInfo = contextSourceInfo;
    return this;
  }

  public CreateCSRRequest addContextSourceInfoItem(KeyValuePair contextSourceInfoItem) {
  ...
  public CreateCSRRequest scope(@javax.annotation.Nullable CsourceRegistrationScope scope) {
    this.scope = scope;
    return this;
  }
  ...
  public CreateCSRRequest mode(@javax.annotation.Nullable ModeEnum mode) {
    this.mode = mode;
    return this;
  }
  ...
  public CreateCSRRequest operations(@javax.annotation.Nullable List<String> operations) {
    this.operations = operations;
    return this;
  }

  public CreateCSRRequest addOperationsItem(String operationsItem) {
  ...
  public CreateCSRRequest refreshRate(@javax.annotation.Nullable String refreshRate) {
  ...
  public CreateCSRRequest management(@javax.annotation.Nullable RegistrationManagementInfo management) {
  ...
  public CreateCSRRequest createdAt(@javax.annotation.Nullable OffsetDateTime createdAt) {
  ...
  public CreateCSRRequest modifiedAt(@javax.annotation.Nullable OffsetDateTime modifiedAt) {
  ...
  public CreateCSRRequest deletedAt(@javax.annotation.Nullable OffsetDateTime deletedAt) {
   ...
   * @return the CreateCSRRequest instance itself
   */
  public CreateCSRRequest putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.id, createCSRRequest.id) &&
        Objects.equals(this.type, createCSRRequest.type) &&
        Objects.equals(this.registrationName, createCSRRequest.registrationName) &&
        Objects.equals(this.description, createCSRRequest.description) &&
        Objects.equals(this.information, createCSRRequest.information) &&
        Objects.equals(this.tenant, createCSRRequest.tenant) &&
        Objects.equals(this.observationInterval, createCSRRequest.observationInterval) &&
        Objects.equals(this.managementInterval, createCSRRequest.managementInterval) &&
        Objects.equals(this.location, createCSRRequest.location) &&
        Objects.equals(this.observationSpace, createCSRRequest.observationSpace) &&
        Objects.equals(this.operationSpace, createCSRRequest.operationSpace) &&
        Objects.equals(this.expiresAt, createCSRRequest.expiresAt) &&
        Objects.equals(this.endpoint, createCSRRequest.endpoint) &&
        Objects.equals(this.contextSourceInfo, createCSRRequest.contextSourceInfo) &&
        Objects.equals(this.scope, createCSRRequest.scope) &&
        Objects.equals(this.mode, createCSRRequest.mode) &&
        Objects.equals(this.operations, createCSRRequest.operations) &&
        Objects.equals(this.refreshRate, createCSRRequest.refreshRate) &&
        Objects.equals(this.management, createCSRRequest.management) &&
        Objects.equals(this.createdAt, createCSRRequest.createdAt) &&
        Objects.equals(this.modifiedAt, createCSRRequest.modifiedAt) &&
        Objects.equals(this.deletedAt, createCSRRequest.deletedAt) &&
        Objects.equals(this.status, createCSRRequest.status) &&
        Objects.equals(this.timesSent, createCSRRequest.timesSent) &&
        Objects.equals(this.timesFailed, createCSRRequest.timesFailed) &&
        Objects.equals(this.lastSuccess, createCSRRequest.lastSuccess) &&
        Objects.equals(this.lastFailure, createCSRRequest.lastFailure)&&
        Objects.equals(this.additionalProperties, createCSRRequest.additionalProperties);
  }
   ...
   * @throws IOException if the JSON Element is invalid with respect to CreateCSRRequest
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!CreateCSRRequest.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
      ...
      for (String requiredField : CreateCSRRequest.openapiRequiredFields) {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       ...
       return (TypeAdapter<T>) new TypeAdapter<CreateCSRRequest>() {
           ...
           public CreateCSRRequest read(JsonReader in) throws IOException {
             ...
             CreateCSRRequest instance = thisAdapter.fromJsonTree(jsonObj);
